...
card_set_test = get_card_set(card_set_testing[0])
buy_menu_test = buy_menu_testing[0]
...
if __name__ == '__main__':
    ...
    for i in range(0, num_games):
        if i < 10:
            ...
            card_set_index = 2
        card_set_test = get_card_set(card_set_testing[card_set_index])
        game = Game(
            agents=[ProvincialAgent(buy_menu = buy_menu_testing[i]), ProvincialAgent(buy_menu = buy_menu_testing[i])],
